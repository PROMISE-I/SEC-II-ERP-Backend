package com.nju.edu.erp.service.Impl.sale_purchase.purchase;

import com.nju.edu.erp.dao.warehouse.product.ProductDao;
import com.nju.edu.erp.dao.sale_purchase.purchase.PurchaseSheetDao;
...
import com.nju.edu.erp.model.po.sale_purchase.purchase.PurchaseSheetContentPO;
...
import com.nju.edu.erp.model.vo.sale_purchase.purchase.PurchaseSheetContentVO;
import com.nju.edu.erp.model.vo.sale_purchase.purchase.PurchaseSheetVO;
import com.nju.edu.erp.model.vo.warehouse.input.WarehouseInputFormContentVO;
...
public class PurchaseServiceImpl implements PurchaseService {
    ...
    public void makePurchaseSheet(UserVO userVO, PurchaseSheetVO purchaseSheetVO) {
        ...
        if (id == null) {
            id = IdGenerator.generateSheetId(latest == null ? null : latest.getId(), "JHD");
        }
