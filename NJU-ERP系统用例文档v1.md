...
| 前置条件 | 总经理已经被识别或授权                                       |
| 后置条件 | 系统记录制定的促销策略                                       |
| 正常流程 | **1.1 制定新的基于总价的促销策略**<br />1. 总经理请求制定新的促销策略<br />2. 系统提示总经理选择促销时间段、输入总价阈值、输入优惠券金额<br />3. 总经理选择促销时间段、输入总价阈值、输入优惠券金额<br />4. 系统提示总经理选择赠品的商品 id、商品数量、商品单价、赠品备注<br />5. 总经理选择赠品的商品 id、商品数量、商品单价、赠品备注<br />6. 系统提示总经理填写促销策略备注<br />7. 总经理填写促销策略备注<br />8. 总经理确认创建基于总价的促销策略<br />9. 系统记录创建的基于总价的促销策略<br />**1.2 制定新的基于组合的促销策略**<br />1. 总经理请求制定新的促销策略<br />2. 系统提示总经理选择促销时间段、折让金额、商品<br />3. 总经理选择促销时间段、折让金额、商品<br />4. 总经理确认创建基于总价的促销策略<br />5. 系统记录创建的基于总价的促销策略<br />**1.3 制定新的基于用户级别的促销策略**<br />***TODO*** |
