...
| 财务人员     | 1. 账户管理<br />2. 收款<br />3. 付款<br />4. 工资发放<br />5. 查看销售明细表<br />6. 查看经营历程表<br />7. 查看经营情况表 |
| 人力资源人员 | 1. 员工管理<br />2. 员工打卡（属于人力资源模块，所有参与者参与）<br />3. 岗位管理 |
| 总经理       | 1. 审批单据<br />2. 制定促销策略<br />3. 制定年终奖<br />4. 查看销售明细表<br />5. 查看经营历程表<br />6. 查看经营情况表 |
...
| ID       | UC2.1 进货管理                                               |
| -------- | ------------------------------------------------------------ |
| 参与者   | 销售管理人员（销售员、销售经理），总经理，总经理，目标是快速、正确地完成进货操作 |
| 触发条件 | 有商品准备进货                                               |
...
| ID       | UC2.3 销售管理                                               |
| -------- | ------------------------------------------------------------ |
| 参与者   | 销售管理人员（销售员、销售经理），总经理，目标是快速、正确地完成销售操作 |
| 触发条件 | 有商品准备销售                                               |
| 前置条件 | 销售管理人员必须已经被识别或授权                             |
| 后置条件 | 系统记录商品销售并修改库存                                   |
...
| ID       | UC2.4 销售退货管理                                           |
| -------- | ------------------------------------------------------------ |
| 参与者   | 销售管理人员（销售员、销售经理），总经理，目标是快速、正确地完成销售退货操作 |
| 触发条件 | 有商品准备销售退货                                           |
| 前置条件 | 销售管理人员必须已经被识别或授权                             |
...
| ID       | UC4.3 岗位管理                                               |
| -------- | ------------------------------------------------------------ |
| 参与者   | 人力资源人员，目的是管理岗位工资、级别和税率                 |
| 触发条件 | 人力资源人员需要修改岗位信息                                 |
| 前置条件 | 人力资源人员已经被识别或授权                                 |
| 后置条件 | 系统记录对岗位信息的修改                                     |
| 正常流程 | 1. 人力资源人员选择要修改的岗位<br />2. 系统提示人力资源人员输入基本工资、岗位工资、岗位级别、扣税信息<br />3. 人力资源人员输入基本工资、岗位工资、岗位级别、扣税信息<br />4. 人力资源人员确认修改<br />5. 系统记录修改后的岗位信息 |
| 扩展流程 | 无                                                           |
| 特殊需求 | 无                                                           |
...
| ID       | UC5.2 制定促销策略                                           |
| -------- | ------------------------------------------------------------ |
| 参与者   | 总经理，目标是制定促销策略，实现促销                         |
| 触发条件 | 总经理需要制定促销策略                                       |
| 前置条件 | 总经理已经被识别或授权                                       |
| 后置条件 | 系统记录制定的促销策略                                       |
| 正常流程 | **1.1 制定新的基于总价的促销策略**<br />1. 总经理请求制定新的促销策略<br />2. 系统提示总经理选择促销时间段、输入总价阈值、输入优惠券金额<br />3. 总经理选择促销时间段、输入总价阈值、输入优惠券金额<br />4. 系统提示总经理选择赠品的商品 id、商品数量、商品单价、赠品备注<br />5. 总经理选择赠品的商品 id、商品数量、商品单价、赠品备注<br />6. 系统提示总经理填写促销策略备注<br />7. 总经理填写促销策略备注<br />8. 总经理确认创建基于总价的促销策略<br />9. 系统记录创建的基于总价的促销策略<br />**1.2 制定新的基于组合的促销策略**<br />1. 总经理请求制定新的促销策略<br />2. 系统提示总经理选择促销时间段、折让金额、商品<br />3. 总经理选择促销时间段、折让金额、商品<br />4. 总经理确认创建基于总价的促销策略<br />5. 系统记录创建的基于总价的促销策略<br />**1.3 制定新的基于用户级别的促销策略**<br />1. 总经理请求编辑某用户级别对应的促销策略<br />2. 系统提示总经理选择促销时间段、输入折让比例、输入代金券、选择赠品并输入数量<br />3. 总经理选择促销时间段、输入折让比例、输入代金券、选择赠品并输入数量<br />4. 若有多种赠品，总经理请求添加赠品<br />5. 系统提示选择新的赠品并输入新的数量<br />6. 重复第 4、5 步直到录入所有赠品<br />7. 总经理确认修改用户级别促销策略<br />8. 系统保存本次修改 |
| 扩展流程 | **1.4 删除促销策略**<br />1. 总经理请求删除促销策略<br />2. 系统提示总经理确认删除促销策略<br />3. 总经理确认删除促销策略<br />4. 系统记录删除促销策略 |
| 特殊需求 | 无                                                           |
